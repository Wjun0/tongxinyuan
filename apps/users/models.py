...
class User(models.Model):
    user_id = models.CharField(max_length=32, default='', verbose_name="用户ID", unique=True)
    ...
    role = models.IntegerField(default=100, verbose_name='管理员0|审核员1|运营人员2|其他用100')
    ...
    token = models.CharField(max_length=32, default='', verbose_name="token")
    token_exp = models.DateTimeField(default=datetime.datetime.now(), null=True, verbose_name='token 过期时间')
